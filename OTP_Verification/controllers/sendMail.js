...
const sendMail=async (req,res,data)=>{
    ...
    to: data.email, // list of receivers ; write receiver's gmail address in place of ...
    subject: "Your One-Time Password (OTP)", // Subject line
    text: `Your OTP is: ${data.otp}. Please use this OTP to verify your identity.`, // plain text body
